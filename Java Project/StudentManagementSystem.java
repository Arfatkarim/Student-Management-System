...
public class StudentManagementSystem extends JFrame {
    ...
    // Create header panel with developer info and links
    ...
    // Create table panel for student list
    ...
    private void addStudent() {
        try {
            ...
            if (name.isEmpty() || roll.isEmpty() || id.isEmpty() || email.isEmpty() || dept.isEmpty() || 
                cgpa.isEmpty() || course.isEmpty() || exam.isEmpty() || result.isEmpty() || 
                faculty.isEmpty() || tuitionFee.isEmpty()) {
            ...
            Student student = new Student(name, roll, id, email, dept, cgpa, course, exam, result, faculty, tuitionFee);
            students.add(student);
            tableModel.addRow(new String[]{name, roll, id, email, dept, cgpa, course, exam, result, faculty, tuitionFee});
            clearFields();
